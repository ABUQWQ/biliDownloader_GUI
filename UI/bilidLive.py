...
"")
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.lab_roomtitle)
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.lab_uid)
        ...
        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.lab_livestatus)
        ...
        self.formLayout.setWidget(4, QFormLayout.ItemRole.FieldRole, self.lab_startime)
        ...
        self.formLayout.setWidget(5, QFormLayout.ItemRole.FieldRole, self.lab_livetag)
        ...
        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.lab_roomid)
        ...
        self.formLayout_2.setWidget(0, QFormLayout.ItemRole.LabelRole, self.label_27)

        self.lab_recordstatus = QLabel(self.formLayoutWidget_2)
        self.lab_recordstatus.setObjectName(u"lab_recordstatus")

        self.formLayout_2.setWidget(0, QFormLayout.ItemRole.FieldRole, self.lab_recordstatus)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.ItemRole.FieldRole, self.lab_chunk)
        ...
        self.formLayout_2.setWidget(2, QFormLayout.ItemRole.FieldRole, self.lab_size)

        self.label_16 = QLabel(self.formLayoutWidget_2)
        self.label_16.setObjectName(u"label_16")

        self.formLayout_2.setWidget(3, QFormLayout.ItemRole.LabelRole, self.label_16)

        self.lab_retime = QLabel(self.formLayoutWidget_2)
        self.lab_retime.setObjectName(u"lab_retime")

        self.formLayout_2.setWidget(3, QFormLayout.ItemRole.FieldRole, self.lab_retime)

        self.label_17 = QLabel(self.formLayoutWidget_2)
        self.label_17.setObjectName(u"label_17")

        self.formLayout_2.setWidget(4, QFormLayout.ItemRole.LabelRole, self.label_17)

        self.lab_transpeed = QLabel(self.formLayoutWidget_2)
        self.lab_transpeed.setObjectName(u"lab_transpeed")

        self.formLayout_2.setWidget(4, QFormLayout.ItemRole.FieldRole, self.lab_transpeed)

        self.label_19 = QLabel(self.formLayoutWidget_2)
        self.label_19.setObjectName(u"label_19")

        self.formLayout_2.setWidget(5, QFormLayout.ItemRole.LabelRole, self.label_19)

        self.lab_cpu = QLabel(self.formLayoutWidget_2)
        self.lab_cpu.setObjectName(u"lab_cpu")

        self.formLayout_2.setWidget(5, QFormLayout.ItemRole.FieldRole, self.lab_cpu)

        self.label_23 = QLabel(self.formLayoutWidget_2)
        self.label_23.setObjectName(u"label_23")

        self.formLayout_2.setWidget(6, QFormLayout.ItemRole.LabelRole, self.label_23)

        self.lab_ram = QLabel(self.formLayoutWidget_2)
        self.lab_ram.setObjectName(u"lab_ram")

        self.formLayout_2.setWidget(6, QFormLayout.ItemRole.FieldRole, self.lab_ram)

        self.label_25 = QLabel(self.formLayoutWidget_2)
        self.label_25.setObjectName(u"label_25")

        self.formLayout_2.setWidget(7, QFormLayout.ItemRole.LabelRole, self.label_25)

        self.lab_spaces = QLabel(self.formLayoutWidget_2)
        self.lab_spaces.setObjectName(u"lab_spaces")

        self.formLayout_2.setWidget(7, QFormLayout.ItemRole.FieldRole, self.lab_spaces)

...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1097, 792)
        icon = QIcon()
        icon.addFile(u":/Icon/images/bilidownloader.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"/* \u5206\u7ec4\u6846\u6837\u5f0f */\n"
"QGroupBox{\n"
"	border: 2px solid rgb(255, 153, 15"
                        "3);\n"
"	border-radius: 15px;\n"
"	margin-top: 2ex;\n"
"}\n"
...
"")
        ...
        self.mainwidget.setGeometry(QRect(40, 40, 1011, 711))
        ...
        self.tw_nodelist.setGeometry(QRect(750, 290, 231, 391))
...
"")
        ...
        self.groupBox.setGeometry(QRect(30, 50, 711, 631))
        ...
        self.list_NodeChoose.setGeometry(QRect(0, 60, 711, 401))
        ...
        self.btn_downCurChoose.setGeometry(QRect(560, 550, 141, 31))
        self.formLayoutWidget = QWidget(self.groupBox)
        self.formLayoutWidget.setObjectName(u"formLayoutWidget")
        self.formLayoutWidget.setGeometry(QRect(10, 510, 351, 111))
        ...
        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.lab_ivName)
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.lab_curchoose)
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.lab_curNID)
        ...
        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.lab_curStatus)
        ...
        self.cb_RSaCC.setGeometry(QRect(380, 560, 151, 19))
        ...
        self.btn_stRecu.setGeometry(QRect(380, 590, 151, 31))
        ...
        self.btn_select_None = QPushButton(self.mainwidget)
        self.btn_select_None.setObjectName(u"btn_select_None")
        self.btn_select_None.setGeometry(QRect(870, 260, 101, 31))
